...
import hirain.carina.VehicleArea;
import hirain.carina.PropertyGroup;
import hirain.carina.PropertyType;
...
enum VehicleProperty {
  ...
  EV_CURRENT_BATTERY_CAPACITY = (((0x030D + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.FLOAT) /* 291504909 */,
  ...
  ENGINE_IDLE_AUTO_STOP_ENABLED = (((0x0320 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287310624 */,
  ...
  EV_BRAKE_REGENERATION_LEVEL = (((0x040C + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289408012 */,
  ...
  EV_STOPPING_MODE = (((0x040D + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289408013 */,
  ...
  HW_KEY_INPUT_V2 = (((0x0A11 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.MIXED) /* 367004177 */,
  HW_MOTION_INPUT = (((0x0A12 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.MIXED) /* 367004178 */,
  ...
  DOOR_CHILD_LOCK_ENABLED = (((0x0B03 + PropertyGroup.SYSTEM) + VehicleArea.DOOR) + PropertyType.BOOLEAN) /* 371198723 */,
  ...
  MIRROR_AUTO_FOLD_ENABLED = (((0x0B46 + PropertyGroup.SYSTEM) + VehicleArea.MIRROR) + PropertyType.BOOLEAN) /* 337644358 */,
  MIRROR_AUTO_TILT_ENABLED = (((0x0B47 + PropertyGroup.SYSTEM) + VehicleArea.MIRROR) + PropertyType.BOOLEAN) /* 337644359 */,
  ...
  SEAT_HEADREST_HEIGHT_POS_V2 = (((0x0BA4 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518820 */,
  ...
  SEAT_FOOTWELL_LIGHTS_STATE = (((0x0B9B + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518811 */,
  SEAT_FOOTWELL_LIGHTS_SWITCH = (((0x0B9C + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518812 */,
  SEAT_EASY_ACCESS_ENABLED = (((0x0B9D + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.BOOLEAN) /* 354421661 */,
  SEAT_AIRBAG_ENABLED = (((0x0B9E + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.BOOLEAN) /* 354421662 */,
  SEAT_CUSHION_SIDE_SUPPORT_POS = (((0x0B9F + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518815 */,
  SEAT_CUSHION_SIDE_SUPPORT_MOVE = (((0x0BA0 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518816 */,
  SEAT_LUMBAR_VERTICAL_POS = (((0x0BA1 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518817 */,
  SEAT_LUMBAR_VERTICAL_MOVE = (((0x0BA2 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518818 */,
  SEAT_WALK_IN_POS = (((0x0BA3 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518819 */,
  ...
  WINDSHIELD_WIPERS_PERIOD = (((0x0BC5 + PropertyGroup.SYSTEM) + VehicleArea.WINDOW) + PropertyType.INT32) /* 322964421 */,
  WINDSHIELD_WIPERS_STATE = (((0x0BC6 + PropertyGroup.SYSTEM) + VehicleArea.WINDOW) + PropertyType.INT32) /* 322964422 */,
  WINDSHIELD_WIPERS_SWITCH = (((0x0BC7 + PropertyGroup.SYSTEM) + VehicleArea.WINDOW) + PropertyType.INT32) /* 322964423 */,
  STEERING_WHEEL_DEPTH_POS = (((0x0BE0 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410016 */,
  STEERING_WHEEL_DEPTH_MOVE = (((0x0BE1 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410017 */,
  STEERING_WHEEL_HEIGHT_POS = (((0x0BE2 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410018 */,
  STEERING_WHEEL_HEIGHT_MOVE = (((0x0BE3 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410019 */,
  STEERING_WHEEL_THEFT_LOCK_ENABLED = (((0x0BE4 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287312868 */,
  STEERING_WHEEL_LOCKED = (((0x0BE5 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287312869 */,
  STEERING_WHEEL_EASY_ACCESS_ENABLED = (((0x0BE6 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287312870 */,
  GLOVE_BOX_DOOR_POS = (((0x0BF0 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.INT32) /* 356518896 */,
  GLOVE_BOX_LOCKED = (((0x0BF1 + PropertyGroup.SYSTEM) + VehicleArea.SEAT) + PropertyType.BOOLEAN) /* 354421745 */,
  VEHICLE_MAP_SERVICE = (((0x0C00 + 0x10000000) + 0x01000000) + 0x00e00000) /* 299895808 */,
  LOCATION_CHARACTERIZATION = (((0x0C10 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410064 */,
  ...
  STEERING_WHEEL_LIGHTS_STATE = (((0x0F0C + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410828 */,
  STEERING_WHEEL_LIGHTS_SWITCH = (((0x0F0D + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410829 */,
  ...
  SHUTDOWN_REQUEST = (((0x0F49 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289410889 */,
  VEHICLE_IN_USE = (((0x0F4A + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313738 */,
  AUTOMATIC_EMERGENCY_BRAKING_ENABLED = (((0x1000 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313920 */,
  AUTOMATIC_EMERGENCY_BRAKING_STATE = (((0x1001 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411073 */,
  FORWARD_COLLISION_WARNING_ENABLED = (((0x1002 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313922 */,
  FORWARD_COLLISION_WARNING_STATE = (((0x1003 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411075 */,
  BLIND_SPOT_WARNING_ENABLED = (((0x1004 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313924 */,
  BLIND_SPOT_WARNING_STATE = (((0x1005 + PropertyGroup.SYSTEM) + VehicleArea.MIRROR) + PropertyType.INT32) /* 339742725 */,
  LANE_DEPARTURE_WARNING_ENABLED = (((0x1006 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313926 */,
  LANE_DEPARTURE_WARNING_STATE = (((0x1007 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411079 */,
  LANE_KEEP_ASSIST_ENABLED = (((0x1008 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313928 */,
  LANE_KEEP_ASSIST_STATE = (((0x1009 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411081 */,
  LANE_CENTERING_ASSIST_ENABLED = (((0x100A + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313930 */,
  LANE_CENTERING_ASSIST_COMMAND = (((0x100B + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411083 */,
  LANE_CENTERING_ASSIST_STATE = (((0x100C + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411084 */,
  EMERGENCY_LANE_KEEP_ASSIST_ENABLED = (((0x100D + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313933 */,
  EMERGENCY_LANE_KEEP_ASSIST_STATE = (((0x100E + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411086 */,
  CRUISE_CONTROL_ENABLED = (((0x100F + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313935 */,
  CRUISE_CONTROL_TYPE = (((0x1010 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411088 */,
  CRUISE_CONTROL_STATE = (((0x1011 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411089 */,
  CRUISE_CONTROL_COMMAND = (((0x1012 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411090 */,
  CRUISE_CONTROL_TARGET_SPEED = (((0x1013 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.FLOAT) /* 291508243 */,
  ADAPTIVE_CRUISE_CONTROL_TARGET_TIME_GAP = (((0x1014 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411092 */,
  ADAPTIVE_CRUISE_CONTROL_LEAD_VEHICLE_MEASURED_DISTANCE = (((0x1015 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411093 */,
  HANDS_ON_DETECTION_ENABLED = (((0x1016 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.BOOLEAN) /* 287313942 */,
  HANDS_ON_DETECTION_DRIVER_STATE = (((0x1017 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411095 */,
  HANDS_ON_DETECTION_WARNING = (((0x1018 + PropertyGroup.SYSTEM) + VehicleArea.GLOBAL) + PropertyType.INT32) /* 289411096 */,
}
