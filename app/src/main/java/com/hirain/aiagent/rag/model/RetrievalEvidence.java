...
public record RetrievalEvidence(String retrievalEvidenceId, String chunkId, String parentChunkId, String content,
                                ...
                                RetrievalConfidence retrievalConfidence, ParentRankingDiagnostics parentRankingDiagnostics) {
    public RetrievalEvidence(String retrievalEvidenceId, String chunkId, String parentChunkId, String content,
                             String documentId, String documentTitle, String documentVersion, String chapter, String section,
                             SourceLocator sourceLocator, Double denseDistance, Integer denseRank, Double lexicalScore,
                             Integer lexicalRank, Double fusionScore, Integer fusionRank, Double rerankScore, Integer rerankRank,
                             List<String> retrievalSources, Applicability applicability) {
        this(retrievalEvidenceId, chunkId, parentChunkId, content, documentId, documentTitle, documentVersion,
                chapter, section, section, sourceLocator, denseDistance, denseRank, lexicalScore, lexicalRank,
                fusionScore, fusionRank, rerankScore, rerankRank, retrievalSources, applicability,
