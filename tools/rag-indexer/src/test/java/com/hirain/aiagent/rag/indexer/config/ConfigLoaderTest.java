...
final class ConfigLoaderTest {
 ...
 private RagBuildConfig load(String json)throws Exception {Path f=dir.resolve("c.json");Files.writeString(f,json);return new ConfigLoader().load(f);}
    ...
    private static String reordered(){return "{\"qualityGate\":{\"state\":\"TEST_ONLY\"},\"lexical\":{\"analyzerVersion\":2,\"algorithm\":\"BM25\"},\"objectBox\":{},\"embedding\":{\"templateVersion\":2,\"dimension\":1024,\"model\":\"text-embedding-v4\",\"provider\":\"DashScope\"},\"chunking\":{},\"parser\":{\"markdown\":{\"extensions\":[\"GFM_TABLE\"],\"syntax\":\"COMMONMARK\"},\"html\":{\"scriptExecution\":false,\"networkAccess\":false,\"mode\":\"STATIC_DOM_ONLY\",\"contentRootSelector\":\"\",\"excludeSelectors\":[]},\"pdf\":{\"tableStrategyOverrides\":[],\"tableStrategy\":\"AUTO\"},\"limits\":{}},\"schemaVersion\":1}";}
}
